...
export async function getStaticPaths() {
  ...
  // );
  //console.log('process.env.API_URL+"api/getHomeCampNews"', process.env.API_URL+"api/getHomeCampNewsAndSponsPartner");
  const response = await fetch(
    process.env.API_URL+"api/getHomeCampNewsAndSponsPartner"
  );
...
export async function getStaticProps(context) { 
  ...
  const response = await fetch( process.env.API_URL +"api/getHomeCampNewsAndSponsPartner?id=" +context.params.news_id);
